...
static uint32_t all_mscl_formats[] = {
    ...
    HAL_PIXEL_FORMAT_EXYNOS_YCrCb_422_I,            // YVYU
    HAL_PIXEL_FORMAT_YCbCr_422_SP,                  // YUV422 2P (YUV422 semi-planar)
    HAL_PIXEL_FORMAT_EXYNOS_YCbCr_422_P,            // YUV 4:2:2 planar, Y/Cb/Cr
};
...
static uint32_t all_mscl_sbwc_v2_7_formats[] = {
    HAL_PIXEL_FORMAT_RGBA_8888,
    HAL_PIXEL_FORMAT_BGRA_8888,
    HAL_PIXEL_FORMAT_RGBX_8888,
    HAL_PIXEL_FORMAT_RGBA_1010102,
...
static uint32_t all_mscl_sbwc_v2_8_formats[] = {
    HAL_PIXEL_FORMAT_RGBA_8888,
    HAL_PIXEL_FORMAT_BGRA_8888,
    HAL_PIXEL_FORMAT_RGBX_8888,
    HAL_PIXEL_FORMAT_RGBA_1010102,
    ...
    HAL_PIXEL_FORMAT_EXYNOS_420_SPN_10B_32_SBWC_L,
    HAL_PIXEL_FORMAT_EXYNOS_420_SPN_10B_64_SBWC_L,
    HAL_PIXEL_FORMAT_EXYNOS_420_SP_M_64_SBWC_L_FR,
    HAL_PIXEL_FORMAT_EXYNOS_420_SP_M_10B_64_SBWC_L_FR,
    HAL_PIXEL_FORMAT_EXYNOS_420_SPN_SBWC_DECOMP,
    HAL_PIXEL_FORMAT_EXYNOS_P010_N_SBWC_DECOMP,
    HAL_PIXEL_FORMAT_EXYNOS_YCbCr_420_SPN_256_SBWC,
    HAL_PIXEL_FORMAT_EXYNOS_YCbCr_420_SPN_10B_256_SBWC,
...
const static stHW2DCapability __capability_fimg2d_9810_blter = {
    ...
    .max_downsizing_factor = {32767, 32767},
    .min_src_dimension = {1, 1},
    .max_src_dimension = {16384, 16384},
    .min_dst_dimension = {1, 1},
    .max_dst_dimension = {16384, 16384},
    .min_pix_align = {1, 1},
    .rescaling_count = 0,
    .compositing_mode = HW2DCapability::BLEND_NONE | HW2DCapability::BLEND_SRC_COPY | HW2DCapability::BLEND_SRC_OVER,
    .transform_type = HW2DCapability::TRANSFORM_ALL,
    .auxiliary_feature = HW2DCapability::FEATURE_PLANE_ALPHA | HW2DCapability::FEATURE_UORDER_WRITE,
    .num_formats = sizeof(blter_formats) / sizeof(blter_formats[0]),
    .num_dataspaces = sizeof(all_hwc_dataspaces) / sizeof(all_hwc_dataspaces[0]),
    .max_layers = 2,
    .pixformats = blter_formats,
    .dataspaces = all_hwc_dataspaces,
    .base_align = 1,
};
...
const static stHW2DCapability __capability_mscl_votf = {
    .max_upsampling_num = {64, 64},
    .max_downsampling_factor = {16, 16},
    .max_upsizing_num = {64, 64},
    .max_downsizing_factor = {16, 16},
...
const static stHW2DCapability __capability_mscl_sbwc_v2_7 = {
    .max_upsampling_num = {4096, 4096},
    .max_downsampling_factor = {256, 256},
    .max_upsizing_num = {4096, 4096},
    .max_downsizing_factor = {256, 256},
    .min_src_dimension = {16, 16},
    .max_src_dimension = {16384, 16384},
    .min_dst_dimension = {4, 4},
    .max_dst_dimension = {16384, 16384},
    ...
    .transform_type = HW2DCapability::TRANSFORM_ALL,
    .auxiliary_feature = 0,
    .num_formats = ARRSIZE(all_mscl_sbwc_v2_7_formats),
    .num_dataspaces = ARRSIZE(all_hwc_dataspaces),
    .max_layers = 1,
    .pixformats = all_mscl_sbwc_v2_7_formats,
    .dataspaces = all_hwc_dataspaces,
    .base_align = 4,
};

const static stHW2DCapability __capability_mscl_sbwc_v2_8 = {
    .max_upsampling_num = {4096, 4096},
    .max_downsampling_factor = {256, 256},
    .max_upsizing_num = {4096, 4096},
    .max_downsizing_factor = {256, 256},
    ...
    .transform_type = HW2DCapability::TRANSFORM_ALL,
    .auxiliary_feature = 0,
    .num_formats = ARRSIZE(all_mscl_sbwc_v2_8_formats),
    .num_dataspaces = ARRSIZE(all_hwc_dataspaces),
    .max_layers = 1,
    .pixformats = all_mscl_sbwc_v2_8_formats,
    .dataspaces = all_hwc_dataspaces,
    .base_align = 4,
};
...
static const HW2DCapability capability_mscl_votf(__capability_mscl_votf);
static const HW2DCapability capability_mscl_sbwc_v2_7(__capability_mscl_sbwc_v2_7);
static const HW2DCapability capability_mscl_sbwc_v2_8(__capability_mscl_sbwc_v2_8);
...
Acrylic *Acrylic::createInstance(const char *spec)
{
    ...
    } else if (strcmp(spec, "mscl_votf") == 0) {
        compositor = new AcrylicCompositorMSCL9810(capability_mscl_votf);
    } else if (strcmp(spec, "mscl_sbwc_v2_7") == 0) {
        compositor = new AcrylicCompositorMSCL9810(capability_mscl_sbwc_v2_7);
    } else if (strcmp(spec, "mscl_sbwc_v2_8") == 0) {
        compositor = new AcrylicCompositorMSCL9810(capability_mscl_sbwc_v2_8);
