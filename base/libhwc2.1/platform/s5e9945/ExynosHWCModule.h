...
const exynos_mpp_t AVAILABLE_OTF_MPP_UNITS[] = {
    // s5e9945 has 8 Graphics-Only Layers
    // s5e9945 has 8 Video-Graphics Layers
    // s5e9945 has total 16 Composition Layers

    // DPP0(IDMA_G0) in DPUF0 is connected with AXI0 port
