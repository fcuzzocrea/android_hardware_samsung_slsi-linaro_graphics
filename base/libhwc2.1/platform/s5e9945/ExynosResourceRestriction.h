...
static feature_support_t feature_table[] =
{
    ...
    {MPP_DPP_GF,
        MPP_ATTR_SAJC | MPP_ATTR_BLOCK_MODE | MPP_ATTR_WINDOW_UPDATE | MPP_ATTR_DIM
    },
    ...
    {MPP_DPP_VGFS,
        MPP_ATTR_SAJC | MPP_ATTR_BLOCK_MODE | MPP_ATTR_WINDOW_UPDATE | MPP_ATTR_SCALE | MPP_ATTR_DIM
    },

    {MPP_DPP_VGRFS,
        MPP_ATTR_SAJC | MPP_ATTR_BLOCK_MODE | MPP_ATTR_WINDOW_UPDATE | MPP_ATTR_SCALE |
    ...
    {MPP_G2D,
        MPP_ATTR_SAJC | MPP_ATTR_FLIP_H | MPP_ATTR_FLIP_V | MPP_ATTR_ROT_90 |
...
const restriction_key_t restriction_format_table[] =
{
    ...
    {MPP_MSC, NODE_NONE, HAL_PIXEL_FORMAT_EXYNOS_YCbCr_P010_M, 0},
    {MPP_MSC, NODE_NONE, HAL_PIXEL_FORMAT_YCBCR_P010, 0},
