 ...
 * but V4L2 format doesn't show compression ratio.
 * To send information about it, this format should be used before SetFormat.
 */
#define V4L2_PIX_FMT_NV12M_SBWCL_8B_L50     v4l2_fourcc('S','L','8','5')
#define V4L2_PIX_FMT_NV12M_SBWCL_8B_L75     v4l2_fourcc('S','L','8','7')
#define V4L2_PIX_FMT_NV12M_SBWCL_10B_L40    v4l2_fourcc('S','L','1','4')
#define V4L2_PIX_FMT_NV12M_SBWCL_10B_L60    v4l2_fourcc('S','L','1','6')
#define V4L2_PIX_FMT_NV12M_SBWCL_10B_L80    v4l2_fourcc('S','L','1','8')
